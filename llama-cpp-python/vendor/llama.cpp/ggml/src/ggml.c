...
static const struct ggml_type_traits type_traits[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_TURBO4] = {
        .type_name    = "turbo4",
        .blck_size    = TURBO_BLOCK_SIZE,
        .type_size    = TURBO4_BLOCK_BYTES,
        .is_quantized = true,
        .to_float         = (ggml_to_float_t) dequantize_row_turbo4_default,
        .from_float_ref   = (ggml_from_float_t) quantize_row_turbo4_default,
    },
    [GGML_TYPE_TURBO3] = {
        .type_name    = "turbo3",
        .blck_size    = TURBO_BLOCK_SIZE,
        .type_size    = TURBO3_BLOCK_BYTES,
        .is_quantized = true,
        .to_float         = (ggml_to_float_t) dequantize_row_turbo3_default,
        .from_float_ref   = (ggml_from_float_t) quantize_row_turbo3_default,
    },
    [GGML_TYPE_TURBO2] = {
        .type_name    = "turbo2",
        .blck_size    = TURBO_BLOCK_SIZE,
        .type_size    = TURBO2_BLOCK_BYTES,
        .is_quantized = true,
        .to_float         = (ggml_to_float_t) dequantize_row_turbo2_default,
        .from_float_ref   = (ggml_from_float_t) quantize_row_turbo2_default,
    },
