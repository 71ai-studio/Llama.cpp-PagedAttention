...
static const struct ggml_type_traits_cpu type_traits_cpu[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_TURBO4] = {
        .from_float               = (ggml_from_float_t) quantize_row_turbo4_default,
        .vec_dot                  = ggml_vec_dot_turbo4_f32,
        .vec_dot_type             = GGML_TYPE_F32,
        .nrows                    = 1,
    },
    [GGML_TYPE_TURBO3] = {
        .from_float               = (ggml_from_float_t) quantize_row_turbo3_default,
        .vec_dot                  = ggml_vec_dot_turbo3_f32,
        .vec_dot_type             = GGML_TYPE_F32,
        .nrows                    = 1,
    },
    [GGML_TYPE_TURBO2] = {
        .from_float               = (ggml_from_float_t) quantize_row_turbo2_default,
        .vec_dot                  = ggml_vec_dot_turbo2_f32,
        .vec_dot_type             = GGML_TYPE_F32,
        .nrows                    = 1,
    },
};
