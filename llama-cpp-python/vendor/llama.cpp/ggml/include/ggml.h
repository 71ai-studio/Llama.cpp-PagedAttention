...
extern "C" {
    ...
    enum ggml_type {
        ...
        GGML_TYPE_TURBO4  = 41, // 3-bit PolarQuant + 1-bit QJL, 3.76x vs f16
        GGML_TYPE_TURBO3  = 42, // 2-bit PolarQuant + 1-bit QJL, 4.92x vs f16
        GGML_TYPE_TURBO2  = 43, // 1-bit PolarQuant + 1-bit QJL, 7.11x vs f16
        GGML_TYPE_COUNT   = 44,
    };
